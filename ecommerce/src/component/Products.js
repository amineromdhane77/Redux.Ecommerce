          ...
          <div className="col-lg-10 text-end">
            <ul className="nav nav-pills d-inline-flex text-center mb-5">
              <li className="nav-item">
                <Link
                  className="d-flex m-2 py-2 bg-success rounded-pill active nav-item nav-link 
              ...
              <li className="nav-item">
                <Link
                  className="d-flex py-2 m-2 bg-success rounded-pill nav-item nav-link "
              ...
              <li className="nav-item">
                <Link
                  className="d-flex m-2 py-2 bg-success rounded-pill nav-item nav-link "
